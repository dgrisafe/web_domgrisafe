...
```{r}
# place post image
post_image(img_path = "images/rookieresearcher.png")
```
...
* Sortino, J. <a href="https://unsplash.com/photos/worms-eye-view-photography-of-ceiling-LqKhnDzSF-8">Sometimes You Just Have to Look Up.</a> (2017)
