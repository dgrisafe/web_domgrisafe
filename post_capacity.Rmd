...
*Informed Consent* is distinct from Capacity.
...
Capacity is short-term, at a specific moment in time, while competency is longer-term, for specific durations of time.
...
*Applebaum Criteria* are formally assessed to determine capacity using the *[MacArthur Competence Assessment](https://doi.org/10.1176/ps.48.11.1415)*.
...
e.g., Jehovah's Witness belong to a community that rejects blood products.

A caveat is the person must hold these values at baseline.

i.e., They cannot have recently adopted religious values at the time of their procedure.

e.g., A manic patient that declares they joined the Jehovah's Witness faith that day lacks capacity to reject blood products if their life depended on them.
...
## Hierarchy of Medical Decision Maker

Medical decision makers may be legally assigned. 

* Power of Attorney
* Medical Conservator (e.g., LPS conservator)
* Previous Surrogate

Where no legal decision maker has been identified, hospital protocol may assign the *next of kin* in a formal order.

* Spouse
* Adult Children
* Parents
* Siblings
* Someone who knows the patient (e.g., neighbor, bartender)
...
Patients must be placed on a hold and found to lack competency by a judge to be involuntary hospitalized.
...
Document using the MacArthur Criteria.[@appelbaum_1995_macarthur]
...
In California, patients cannot be force to receive electroconvulsive therapy against their will.

In California, healthcare providers must obtain a *Riese Petition* to administer psychiatric medcations against the will of a patient lacking capacity.
