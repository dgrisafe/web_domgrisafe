...
```{r}
# place post image
post_image(img_path = "images/capacity.png")
```
...
Throughout this discussion, it is helpful to recall the 4 pillars of medical ethics outlined in the [Belmont Report](https://www.hhs.gov/ohrp/regulations-and-policy/belmont-report/read-the-belmont-report/index.html):
...
*[Appelbaum Criteria](https://doi.org/10.1056/NEJM198812223192504)* are formally assessed to determine capacity using the *[MacArthur Competence Assessment](https://doi.org/10.1176/ps.48.11.1415)*.
...
* "What did your doctors tell you was going on?"
...
* "What are some of the things that could happen if you *didn't* have [this intervention]?"
* "What did your doctors tell you could happen? Do you believe that?"
...
* "What makes you prefer [intervention A] over [intervention B]?"
...
### Punnet Square of Risks and Benefits
