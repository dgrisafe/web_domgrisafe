...
names(df_agitate_pretty) = c("Generic (Route)", "Brand", "Initial Dose (mg)", "Time to Max Concentration (min)", "Time until Repeat (min)", "Max Total Daily Dose (mg)")

# print html table
df_agitate_pretty %>% kbl(escape = F) %>% kable_styling() %>% 
  footnote(symbol = c(
